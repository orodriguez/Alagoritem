...
public class LnkListTests
{
    ...
    {
        var l = new LnkList<int>(10, 30, 40);
    ...
    {
        var l = new LnkList<int>(10, 30, 40, 50, 60);
    ...
    {
        var l = new LnkList<int>(10, 20, 30);
